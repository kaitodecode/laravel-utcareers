        ...
        <aside class="sidebar-gradient text-white overflow-auto">
            ...
            <div class="position-absolute bottom-0 start-0 end-0 p-3">
                <div class="profile-card rounded p-3">
                    <div class="d-flex align-items-center gap-3">
                        <img class="rounded-circle border border-2 border-primary-custom" src="https://ui-avatars.com/api/?name=Admin+User&background=ffd401&color=000" alt="Admin" width="40" height="40">
                        <div class="flex-grow-1">
                            <p class="small fw-medium text-white mb-0">Admin User</p>
                ...
                <div class="d-flex justify-content-between align-items-center px-4 py-3">
                    <div>
                        <h2 class="h4 mb-0 d-flex align-items-center gap-2">
                            @yield('title', '<i class="fas fa-hand-wave text-primary-custom"></i> Welcome back, Admin!')
                        </h2>
                    </div>
                    <div class="d-flex align-items-center gap-4">
                        <!-- Search -->
                        <div class="position-relative">
                            <input type="text" placeholder="Search anything..." class="form-control search-box bg-light border-0 rounded-pill ps-4 py-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="#" class="dropdown-item">New application received</a>
                            <a href="#" class="dropdown-item">Interview scheduled</a>
                            <a href="#" class="dropdown-item">New message from HR</a>
                        </div>

                        <!-- Messages -->
                        <button class="btn top-nav-btn position-relative" data-bs-toggle="dropdown">
                            <i class="fas fa-envelope fs-5"></i>
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-primary-custom text-dark">5</span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <h6 class="dropdown-header">Messages</h6>
                            <a href="#" class="dropdown-item">John: Meeting at 3 PM</a>
                            <a href="#" class="dropdown-item">Sarah: Application status</a>
                            <a href="#" class="dropdown-item">Mike: New position opened</a>
                        </div>

                        <!-- Profile Dropdown -->
                        <div class="dropdown">
                            <button class="btn d-flex align-items-center gap-3 top-nav-btn" data-bs-toggle="dropdown">
                                <img class="rounded-circle border border-2 border-primary-custom" src="https://ui-avatars.com/api/?name=Admin+User&background=ffd401&color=000" alt="Admin" width="32" height="32">
                                <div class="text-start d-none d-sm-block">
                                    <p class="small fw-medium mb-0">Admin User</p>
                                    <p class="small text-muted mb-0">Administrator</p>
                                </div>
