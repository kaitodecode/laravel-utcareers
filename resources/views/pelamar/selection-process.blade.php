                        ...
                        <div class="card shadow-sm">
                            <div class="card-header bg-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="mb-1 fw-semibold">{{ $application->jobPost->title ?? 'Job Position' }}
                                        </h5>
                                        <p class="text-muted mb-0 small">
                                            <i
                                                class="fas fa-building me-1"></i>{{ $application->jobPost->company->name ?? 'Company' }}
                                                                    ...
                                                                    <div class="file-preview">
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                <div
                                                                                    class="bg-primary rounded-circle p-2 me-3">
                                                                                    <i
                                                                                        class="fas fa-file-alt text-white"></i>
                                                                                </div>
                                                                                <div>
                                                                                    <h6 class="mb-0">Current Portfolio
                                                                                    </h6>
                                        ...
                                        <div
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                @if ($medicalSelection)
                                                    ...
                                                    @endif
                                                @elseif($interviewSelection && $interviewSelection->status == 'accepted')
